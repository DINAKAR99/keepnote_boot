...
// import com.stackroute.keepnote.service.s;
...
public class UserController {
	...
	public ResponseEntity<?> create(User item) {
		try {
			boolean registerUser = userserv.registerUser(item);
			return new ResponseEntity<>("user created status : " + registerUser, HttpStatus.CREATED);
		} catch (Exception e) {
	...
	public ResponseEntity<?> update(@PathVariable("id") int id,
			@RequestBody User item, HttpSession h1) {

		Object attribute = h1.getAttribute("user");
		if (attribute == null) {
