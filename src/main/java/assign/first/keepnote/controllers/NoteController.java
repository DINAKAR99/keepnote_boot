...
import assign.first.keepnote.repositories.NoteRepository;
...
public class NoteController {
	...
	public String updateNotes(Note n1, @PathVariable("id") int id, Model m) {
		...
		m.addAttribute("message", "note edited success");
	...
	public String updateNoteclick(Model m, @PathVariable("id") int id) {

		m.addAttribute("edit", true);
		Note noteByid = np.getNoteByid(id);

		m.addAttribute("editnote", noteByid);
	...
	public String deleteNotes(@PathVariable("id") int id, Model m) {
		...
		if (deleteNote == true) {
			...
			m.addAttribute("notespack", allNotes);
			m.addAttribute("message", "note delete success");
			return "index";

		} else {

			m.addAttribute("notespack", allNotes);
			m.addAttribute("message", "note delete fail");
			return "index";
		}
